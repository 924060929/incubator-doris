...
/**
 * AggregateFunction 'variance_samp'. This class is generated by GenerateFunction.
 */
public class VarianceSamp extends AggregateFunction
     ...
     */
    public VarianceSamp(Expression arg) {
        super("variance_samp", arg);
    }

    /**
     * constructor with 1 argument.
     */
    public VarianceSamp(boolean distinct, Expression arg) {
        super("variance_samp", distinct, arg);
    }
    ...
    public VarianceSamp withDistinctAndChildren(boolean distinct, List<Expression> children) {
        ...
        return new VarianceSamp(distinct, children.get(0));
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitVarianceSamp(this, context);
    }
