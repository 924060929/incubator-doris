...
public class PartitionRangePredicateNormalizer {
    ...
    private NormalizedPartitionPredicates normalizeSingleRangePartitionColumnPredicates(
        ...
        //             selectedPartitionIds.size() - context.getSessionVariable().getQueryCacheHotPartitionNum());
        //     selectedPartitionIds = selectedPartitionIds.subList(0, excludeHostPartitionIndex);
        // }
