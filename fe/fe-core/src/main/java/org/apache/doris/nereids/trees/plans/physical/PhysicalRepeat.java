...
public abstract class PhysicalRepeat<CHILD_TYPE extends Plan>
    ...
    protected final List<GroupingSetIdSlot> groupingSetIdSlots;
    ...
    public PhysicalRepeat(
        ...
        this.groupingSetIdSlots = ImmutableList.copyOf(groupingSetIdSlots);
    }
    ...
    public List<List<Long>> getVirtualSlotValues() {
        ...
        groupingSetIdSlots.stream().forEach(e -> wholeVirtualSlotValues.add(e.toLongValue()));
        return wholeVirtualSlotValues.build();
    }

    /**
     * Additional virtual columns to display groupingSets.
     */
    public List<BitSet> useBitsetsToRepresentGroupingSets() {
        return groupingSetIdSlots.get(0).genBitSetsForNullSlot();
    }
    ...
    public String toString() {
        return Utils.toSqlString("PhysicalRepeat",
                ...
                "groupingSetIdSlot", groupingSetIdSlots
        );
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(groupByExpressions, that.groupByExpressions)
                ...
                && Objects.equals(groupingSetIdSlots, that.groupingSetIdSlots);
    }

    @Override
    public int hashCode() {
        return Objects.hash(groupByExpressions, outputExpressions, groupingSetIdSlots);
    }
}
