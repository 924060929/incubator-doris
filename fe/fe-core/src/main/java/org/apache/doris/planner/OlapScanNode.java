...
public class OlapScanNode extends ScanNode {
    ...
    public Pair<PlanNode, LocalExchangeType> enforceAndDeriveLocalExchange(
        ...
        boolean poolingScan = fragment.useSerialSource(translatorContext.getConnectContext());
        if (poolingScan) {
            LocalExchangeType preferType = parentRequire.noopTo(LocalExchangeType.BUCKET_HASH_SHUFFLE);
