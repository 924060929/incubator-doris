...
public class Avg extends AggregateFunction
        implements UnaryExpression, ExplicitlyCastableSignature, PropagateNullable, DecimalWiderPrecision {
    ...
    public Avg withDistinctAndChildren(boolean distinct, List<Expression> children) {
        ...
        return new Avg(distinct, children.get(0));
    }
