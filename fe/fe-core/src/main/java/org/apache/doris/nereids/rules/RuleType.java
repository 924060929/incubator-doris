...
public enum RuleType {
    ...
    FILL_UP_HAVING_AGGREGATE_REPEAT(RuleTypeClass.REWRITE),
    ...
    REWRITE_GROUP_BY_EXPRESSION(RuleTypeClass.REWRITE),
    ...
    LOGICAL_GROUP_SETS_TO_PHYSICAL_GROUP_SETS_RULE(RuleTypeClass.IMPLEMENTATION),
