...
public enum RuleType {
    ...
    DISASSEMBLE_ONE_PHASE_AGGREGATE_WITHOUT_DISTINCT(RuleTypeClass.EXPLORATION),
    DISASSEMBLE_TWO_PHASE_AGGREGATE_WITHOUT_DISTINCT(RuleTypeClass.EXPLORATION),
    DISASSEMBLE_TWO_PHASE_AGGREGATE_WITH_DISTINCT(RuleTypeClass.EXPLORATION),
    DISASSEMBLE_THREE_PHASE_AGGREGATE_WITH_DISTINCT(RuleTypeClass.EXPLORATION),
